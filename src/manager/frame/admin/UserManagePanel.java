...
public class UserManagePanel extends JInternalFrame {
    ...
    public UserManagePanel() {
        ...
        delBtn.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                int r = JOptionPane.showConfirmDialog(UserManagePanel.this, "确定删除该用户？", "提示", JOptionPane.YES_NO_OPTION);
    ...
    private void search() {
        table.setModel(new DefaultTableModel(UserDao.queryAllUsers(searchField.getText()), UserDao.columnNames));
    }
    ...
    private void showEditDialog(Users user) {
        ...
        p.add(new JLabel("密码:"));
        p.add(pwdField);
        int r = JOptionPane.showConfirmDialog(this, p, user == null ? "添加用户" : "修改用户", JOptionPane.OK_CANCEL_OPTION);
